   ...
   <div style={backgroundStyle}> 
    <section className='max-container'>
      ...
      <div className='mt-5 flex flex-col gap-3 text-slate-500'>
        <p>
          FullStack Developer from India, specializing in web development
          and building resourceful applications.
        </p>
      </div>
      ...
      <div className='py-16'>
        ...
        <div className='mt-5 flex flex-col gap-3 text-slate-500'>
          <p>
            ...
            teaming up with smart people. Here's the rundown of the company:
          </p>
        </div>
